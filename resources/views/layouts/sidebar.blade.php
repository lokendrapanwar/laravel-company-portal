            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a href="{{url('/leaves')}}">Leaves (Admin) <span class="badge badge-pill bg-primary float-right">1</span></a></li>
                        <li><a href="{{url('/holidays')}}" hrsef="leaves-employee.html">Leaves (Employee)</a></li>
                        <li><a href="{{url('/holidays')}}" hrsef="leave-settings.html">Leave Settings</a></li>
                        <li><a href="{{url('/attendance')}}">Attendance (Admin)</a></li>
                        <li><a href="{{url('/holidays')}}" hrsef="attendance-employee.html">Attendance (Employee)</a></li>
                        <li><a href="{{url('/departments')}}">Departments</a></li>
                        <li><a href="{{url('/designations')}}">Designations</a></li>
                        <li><a href="{{url('/timesheets')}}">Timesheet</a></li>
                        <li><a href="{{url('/holidays')}}" hrsef="shift-scheduling.html">Shift & Schedule</a></li>
